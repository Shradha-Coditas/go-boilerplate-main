...
// Handler - Handle the Post requests at /v1/scrip
// @Summary store data of Scrip ScripComparables request
...
// @Success 201 {object} scrip.ScripComparablesResponse
...
func Handler(c *gin.Context) {
	...
	var RequstPayload scrip.ScripComparables
	//Custom Validator
	...
	err := scrip.AddScripComparables(RequstPayload)
	if err != nil {
